...
input, textarea {
	...
	background: white; 
	background: -webkit-gradient(linear, left top, left 60%, from(#FFFFFF), color-stop(4%, #eeeeee), to(#FFFFFF));  
   background: -moz-linear-gradient(top, #FFFFFF, #eeeeee 1px, #FFFFFF 60%); 
}
